...
\begin{equation}
  ...
  \label{eq:aloha_S}
\end{equation}
and computing the sample mean of the throughput at each iteration. The results are in Figure
...
The results are in Figure, while the throughput computed as in~\eqref{eq:aloha_S} is in Figure

...
\begin{figure}[h!]
	...
	\subfigure[$P_{tx}$ to reach $d = 10$ m as a function of $E_0$, with logarithmic x axis]{\includegraphics[width = 0.45\textwidth]{ptx_e0_log}}
...
\begin{figure}[h!]
	...
	\subfigure[$d_{max}$ as a function of $E_0$ with a logarithmic x axis, for $P_{tx, max} = 100$]{\includegraphics[width= 0.45\textwidth]{dmax_e0_log}}
